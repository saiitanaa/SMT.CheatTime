...
{
    [BepInPlugin("com.saysaa.smt_cheattime", "SMT CheatTime", "1.4")]
    public class TrainerPlugin : BaseUnityPlugin
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Box(new Rect(x, y, boxWidth, boxHeight), "SMT.CheatTime! 1.3");
            ...
            switch (currentTab)
            {
                case 0: //cheats
                    ...
                    if (GUI.Button(new Rect(0, 135, 210, 35), "[+] | Max Franchise Points"))
                        GameData.Instance.NetworkgameFranchisePoints += 999;
